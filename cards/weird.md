...
[[break]]
### The Metal
[[tab]]Expect the most frequent posts to be dedicated to technical topics, software engineering, GPUs, graphics, etc.  Topics I love and that live in my mind; this page was created as an outlet for them as much as a way to set straight whatever is on my mind.  I have 2-3 projects in the rotation at a time to not get burnt out of any single project, actively working on one while keeping the others in context.  Most of these are meant to be a way for me to learn. Right now, I want to learn about the internals of LLMs and their training/inference processes its both interesting to me and increasingly relevant to the work I do. My goal is to write a state-of-the-art local inference engine for some popular small model like Qwen-3.5-35b. Though the "hot" local LLM at the moment shifts day-to-day, so who knows what I'll actually end up targetting.
[[break]]
### The Mediums
[[tab]] Then there are the things I love. The fragments. Film frames and book quotes, the photography, the collected artifacts of my life. The machine wants to strip away time, optimize the execution and bleed out the milliseconds. But these mediums demand friction. You have to advance the film, you have to sit with the text, you have to let the slowing down happen. This is where I find meaning in those moments. Dissecting why a certain slant of light or a quiet scene stays lodged in my head and shifts the way I walk through the city. This is my place to lay those fragments out and share whatever meaning I can wring out of them.
...
[[bigbreak]]
## Conclusion
[[tab]] The site will never be fully finished. It will evolve whenever I need a new way to tell a story, but the foundation is set. From here on, I am only concerned with the work itself: The Mind, The Metal, and The Mediums.